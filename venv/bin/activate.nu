...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/saikumarsilaparasetti/PycharmProjects/entry_automation/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/saikumarsilaparasetti/PycharmProjects/entry_automation/venv/bin/deactivate.nu'
